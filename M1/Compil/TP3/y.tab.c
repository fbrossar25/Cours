...
{
       0,    40,    40,    48,    51,    57,    60,    63,    66,    72,
      81,    84,    87,    90,    93,    96,   102,   107,   118
};
#endif
...
static const char *const yytname[] =
{
  ...
  "statement", "condition", "expression", "tag", YY_NULLPTR
};
#endif
...
{
      16,    27,    27,     3,    11,     0,   -20,   -20,   -20,    27,
      -8,    27,    31,    40,    34,   -20,   -20,   -20,   -20,    -2,
      35,    16,   -20,   -20,    16,   -20,   -20,   -20,   -20,   -20,
      20,    27,    27,     5,   -20,     6,   -20,    16,   -20,    25,
     -20
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,    18,    18,     0,    16,    17,     5,     9,    15,
       0,     0,     0,     0,     6,    12,    13,     0,     7,     0,
       8
};
...
{
      17,    13,    30,    19,     1,    33,    14,     2,    18,     1,
      20,    15,     2,    32,    37,    38,    28,     3,    39,    16,
       1,    23,     3,     2,     1,    17,    34,     2,    17,     1,
      35,    36,     2,     3,    17,    40,    21,     3,     0,     7,
       8,     0,     3,     9,    10,    22,    23,    11,    24,    22,
      23,    25,    26,     0,    22,    23,    29
};

static const yytype_int8 yycheck[] =
{
       5,     2,    21,    11,     4,    24,     3,     7,     9,     4,
      11,     0,     7,    23,     9,    10,    18,    17,    37,    19,
       4,    15,    17,     7,     4,    30,     6,     7,    33,     4,
      31,    32,     7,    17,    39,    10,     5,    17,    -1,    12,
      13,    -1,    17,    16,    17,    14,    15,    20,     8,    14,
      15,    17,    18,    -1,    14,    15,    21
};
...
#line 73 "expr.y" /* yacc.c:1646  */
    {
      struct symbol* arg1 = symbol_get_or_create(&tds, (yyvsp[-2].string));
      struct symbol* arg2 = symbol_newtemp(&tds);
      arg2->isConstant = true;
      arg2->value = (yyvsp[0].value);
      struct symbol* res = symbol_newtemp(&tds);
      (yyval.codegen).code = quad_gen("==",arg1,arg2,res);
    }
