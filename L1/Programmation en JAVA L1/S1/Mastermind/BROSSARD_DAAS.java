...
les différentes nb(0 à 3) sont les nombres tirées au hasard, ils sont utilisé pour construire la chaine reponse (en fonction de leurs valeures respectives) 
chiffre est une variable 'mémoire' qui est utilisé pour construire la chaine reponse (elle mémorise la valeur des variables nbi afin de les 'convertir')
...
//erreur_saisie est un booléen qui est vrai si l'utilisateur à commis une erreur de saisie
for(i=0;i<=3;i++)
	{
		switch(i)  //on tire les 4 nombres (nbi) qui serviront à construire la chaine reponse
		{
			case 0:{
