...
int nb1,nb2,result;                     //nb1 est le premier nombre saisis, nb2 est le second, result est le resultat de l'opération
char operateur;                        
result=0;
...
if(nb2<0)
  ...
  {Ecran.afficher(nb1,operateur,nb2"=",result); //sinon on affiche simplement l'opération
  if(operateur='+')
    {
    Ecran.afficher(nb1,"-",nb2,"=",result);  //si nb2 est négatif on en remplace "+-" dans l'opération par "-" seulement
    }
