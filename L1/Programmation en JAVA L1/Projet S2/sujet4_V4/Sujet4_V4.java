public class Sujet4_V4{
	static final double V_INIT=2500.0;//vitesse initiale des billes lancées
	static final double T_AFFICHAGE=1.0/60.0; //temps avant le prochain affichage si aucun n'évenement ne se produit
