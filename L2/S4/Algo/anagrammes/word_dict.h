...
//table de hash
struct word_dict{
	struct word_dict_bucket **buckets;//tableau de bucket (liste chainée de chaine de caractere)
	size_t count;//nombre d'éléments de la table
	size_t size;//taille du tableau buckets
};
