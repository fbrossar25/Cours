...
#Génère un Makefile permettant de compiler chaque .c du dossier courant en un fichier éxecutable du même nom (sans l'exension .c)
...
echo "LDFLAGS=-lpthread" >> Makefile
...
do
	...
	echo -e "\t\${CC} \${CFLAGS} -o \$@ $CURR.c \${LDFLAGS}\n" >> Makefile
done
